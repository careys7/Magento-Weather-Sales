 ...
 */
class Jcarey_Weather_Model_Rule_Condition_Address extends Mage_SalesRule_Model_Rule_Condition_Address
{
    /**
     * Add in the weather attribute options
     * @return Jcarey_Weather_Model_Rule_Condition_Address 
     */
    public function loadAttributeOptions()
    {
        ...
        $weatherAttributes = array(
            Jcarey_Weather_Model_Service::WEATHER => Mage::helper('salesrule')->__('Weather'),
            Jcarey_Weather_Model_Service::TEMPERATURE => Mage::helper('salesrule')->__('Temperature'),
        );
    ...
    public function getInputType()
    {
        ...
        switch ($this->getAttribute()) {
            case Jcarey_Weather_Model_Service::TEMPERATURE:
                $inputType = 'numeric';
                break;
            case Jcarey_Weather_Model_Service::WEATHER:
